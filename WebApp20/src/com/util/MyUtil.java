...
public class MyUtil
{
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		*/
		...
		currentPageSetup = (currentPage/numPerBlock) * numPerBlock;//			   │여기
		...
		//--listUrl 은 위에서 (라인 85) 이미 전처리가 끝난 상황이기 때문에
		//  『...?』 상태 또는 『...?...&』 인 상태이다.
		//   이로 인해 결과는
