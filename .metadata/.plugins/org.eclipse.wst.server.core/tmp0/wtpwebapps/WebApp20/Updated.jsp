...
<script type="text/javascript">
	...
	function sendIt()
	{
		...
		// ---------------------------------------- 이메일 검사 
		// 이메일 없는 사람도 있기 때문에 입력 확인은 안할 것이다.
		// 그러나 이메일을 입력하면 이메일 포멧에 맞게 입력해야 하기 때문에
				...
				<dl>
					...
					<dd>
						...
						%>
							...
							<textarea name="content" class="boxTA" cols="63" rows="12"><%=dto.getContent() %>
							</textarea>
						<%
						}
						else
						{
						%>
							<textarea name="content" class="boxTA" cols="63" rows="12" disabled="disabled"><%=dto.getContent() %>
							</textarea>
						<%
						}
						%>	
