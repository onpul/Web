...
<%
	...
	{
		week++;						//-- 날짜가 하루씩 찍힐 때마다 (구성이 이루어질 때마다) 요일도 함께 1씩 증가~!!! check~!!!
...
<style type="text/css">
	td {text-align: right;}
	td.now {background-color: yellow; font-weight: bold;}
	td.sat {color: blue;}
	td.sun {color: red;}
	td.nowSat {background-color: yellow; font-weight: bold; color: blue;}
	td.nowSun {background-color: yellow; font-weight: bold; color: red;}
</style>
