...
<%
	...
	// 어려운 개념이니까 느낌만 파악하자! 몰라도 속상해 하지 않아도 된다! 실무자들도 잘 모른다!
	/*==============================================================================================
	...
	※ 처리 과정 및 개념
	   ...
	   이렇게 구성되는 『HttpServlet』의 상속된 클래스의 인스턴스는 // 우리가 만든 서블릿, 인스턴스는 서블릿 컨테이너가 해준 거
	   ...
	   이 『ServletContext』는 『getServletContext()』는
	   ...
	   『RequestDispatcher』 역시 그 기능 중의 하나이다. // ServletContext의 일꾼! 도구! 하인!
	   ...
	   생성해 줄 수는 없다.
	   그렇기 때문에 『Dispatcher』가 생성해 준 새로운 서블릿 스레드를
