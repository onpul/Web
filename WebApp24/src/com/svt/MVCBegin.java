...
public class MVCBegin extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/view/MVCBegin.jsp"); // ★★★★★ 클라이언트는 직접 못 만난다!!!
		dispatcher.forward(request, response);                                                    // 컨트롤러를 통해서만 만날 수 있다!!!
